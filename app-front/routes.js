...
import Notebook from './components/Linked/Notebook';
import Note from './components/Linked/Note';
...
export default (
	<Route path="/" component={App}>
		...
		<Route path="user" component={UserLibrary} >
			...
			<Route path="linked/:notebook" component={Notebook}></Route>
			<Route path="linked/:notebook/:note" component={Note}></Route>
		</Route>
