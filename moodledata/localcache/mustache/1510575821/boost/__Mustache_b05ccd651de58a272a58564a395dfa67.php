...
class __Mustache_b05ccd651de58a272a58564a395dfa67 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        if ($parent = $this->mustache->loadPartial('core_form/element-template')) {
            $context->pushBlockContext(array(
                'element' => array($this, 'block95513a5512c6720a380369bd90a61c55'),
            ));
...
';
    ...
    public function block95513a5512c6720a380369bd90a61c55($context)
    {
        $indent = $buffer = '';
        // 'element.frozen' inverted section
        $value = $context->findDot('element.frozen');
