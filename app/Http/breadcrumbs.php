...
Breadcrumbs::register('lrs.users', function($breadcrumbs, $lrs) {
  $breadcrumbs->push(Lang::get('lrs.sidebar.users'), url('/lrs/' . $lrs->id . '/users'));
});
...
Breadcrumbs::register('editlrs', function($breadcrumbs, $lrs) {
  ...
  $breadcrumbs->push(Lang::get('lrs.edit'), url('/lrs/' . $lrs->id));
});
Breadcrumbs::register('lrs.invite', function($breadcrumbs, $lrs) {
  $breadcrumbs->parent('lrs.users', $lrs);
  $breadcrumbs->push(Lang::get('users.invite.invite'), url('/lrs/' . $lrs->id . '/users'));
});
...
Breadcrumbs::register('site.edit', function($breadcrumbs, $site) {
  ...
  $breadcrumbs->push('Edit settings', url('/site/'. $site->id . '/edit'));
});
/*
|---------------------------------------------------------------
...
Breadcrumbs::register('statement', function($breadcrumbs, $lrs) {
  $breadcrumbs->push('Statements', url('/lrs/'.$lrs->id.'/statements'));
});
Breadcrumbs::register('filter', function($breadcrumbs, $lrs) {
  $breadcrumbs->parent('statement', $lrs);
  $breadcrumbs->push(Lang::get('statements.filter'), url('/lrs/$lrs->id/statements/generator'));
});
Breadcrumbs::register('generator', function($breadcrumbs, $lrs) {
  $breadcrumbs->parent('statement', $lrs);
  $breadcrumbs->push(Lang::get('statements.generator'), url('/lrs/$lrs->id/statements/generator'));
});
Breadcrumbs::register('explorer', function($breadcrumbs, $lrs) {
  $breadcrumbs->parent('statement', $lrs);
  $breadcrumbs->push(Lang::get('statements.explorer'), url('/lrs/$lrs->id/statements/generator'));
});
Breadcrumbs::register('analytics', function($breadcrumbs, $lrs) {
  $breadcrumbs->parent('statement', $lrs);
  $breadcrumbs->push(Lang::get('statements.analytics'), url('/lrs/$lrs->id/statements/generator'));
});
...
Breadcrumbs::register('exporting', function($breadcrumbs, $lrs) {
  $breadcrumbs->push('Exporting', url('/lrs/'.$lrs->id.'/exporting'));
});
Breadcrumbs::register('exporting.create', function($breadcrumbs, $lrs) {
  $breadcrumbs->parent('exporting', $lrs);
  $breadcrumbs->push('Create Export', url('/lrs/'.$lrs->id.'/exporting/create'));
});
Breadcrumbs::register('exporting.view', function($breadcrumbs, $lrs) {
  $breadcrumbs->parent('exporting', $lrs);
  $breadcrumbs->push('View Export', url('/lrs/'.$lrs->id.'/exporting/show'));
});
...
Breadcrumbs::register('reporting', function($breadcrumbs, $lrs) {
  $breadcrumbs->push(Lang::get('statements.reporting'), url('/lrs/'.$lrs->id.'/reporting'));
});
Breadcrumbs::register('reporting.create', function($breadcrumbs, $lrs) {
  $breadcrumbs->parent('reporting', $lrs);
  $breadcrumbs->push(Lang::get('reporting.create'), url('/lrs/'.$lrs->id.'/reporting/create'));
});
Breadcrumbs::register('reporting.view', function($breadcrumbs, $lrs) {
  $breadcrumbs->parent('reporting', $lrs);
  $breadcrumbs->push(Lang::get('reporting.view'), url('/lrs/'.$lrs->id.'/reporting/show'));
});
