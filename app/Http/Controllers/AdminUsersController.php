...
use BibleExchange\Entities\Permission;
use BibleExchange\Entities\Role;
...
class AdminUsersController extends AdminController {
    ...
    public function getIndex()
    {
		...
		$modelTable = 'users';
		$tableHeaders = $this->users->adminTableHeaders;
		
        // Show the page
        return view('admin.resources.index', compact('model', 'title','modelTable','tableHeaders'));
    }
    ...
    public function getShow($user)
    {
    	...
    	return view('admin.users.create_edit',compact('user','mode','roles'));
    }
