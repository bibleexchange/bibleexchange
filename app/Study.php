...
class Study extends BaseModel {
	...
	{
		return $this->hasMany('BibleExperience\Task');
	}
	
	public function questions()
	{
		return $this->hasManyThrough('BibleExperience\Question','BibleExperience\Task');
	}
	...
	{
		return $this->morphMany('BibleExperience\TaskProperty','taskable');
	}

	public function text()
	{
		return $this->belongsTo('BibleExperience\Text','latest_text_id')->first();
	}
	
	public function group()
	{
		return $this->belongsTo('BibleExperience\UrlNamespace','namespace_id');
	}
	
	public function sections()
	{
		return $this->belongsToMany('\BibleExperience\Section')->orderBy('orderBy','ASC')->orderBy('created_at','ASC');
	}
	...
	{
		return $this->belongsTo('BibleExperience\BibleVerse','main_verse');
	}
	...
	*/
	...
	{
		return $this->belongsToMany('\BibleExperience\Recording','recording_study','study_id','recording_id');
	}
	
	public function audios()
	{
		return new \BibleExperience\Recording;
	}
	...
	{
		return \BibleExperience\Revision::editorsFromArray($this->revisions()->get());
	}
	...
	{
		return \BibleExperience\Revision::where('study_id',$this->id);
	}
	
	public function revision()
	{
		return \BibleExperience\Revision::where('text_id', $this->latest_text_id)->where('study_id',$this->id)->first();
	}
