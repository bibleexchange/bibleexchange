...
class Recording extends \Eloquent {
	...
	public function primaryPerson()
	{
		...
		return new \BibleExperience\Person;
		
	}
	
	public function studies()
	{
		return $this->belongsToMany('BibleExperience\Study', 'recording_study','recording_id','study_id');
	}
	
	public function verses()
	{
		return $this->belongsToMany('BibleExperience\BibleVerse', 'recording_verse','recording_id','verse_id');
	}
	
    public function formats()
    {
    	return $this->hasMany('BibleExperience\RecordingFormat');
    }
