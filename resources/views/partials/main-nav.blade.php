			...
			?>
             ...
             <ul class="nav navbar-nav pull-left">
		          	@if (Auth::check() && Auth::user()->hasRole('admin'))
						...
						@endif
						<li class="home {!!$homeState or ''!!}"><a href="{!! url('/') !!}"><span class="glyphicon glyphicon-home" aria-hidden="true" ></span> <span class="hidden-sm hidden-xs">Home</span>
						@if (Auth::check())						
						...
						<li class="bible {!!$bibleState or ''!!}"><a href="{!! url('/bible') !!}"><span class="glyphicon glyphicon-book" aria-hidden="true"></span> <span class="hidden-sm hidden-xs">Holy Bible</span></a>
						</li>
						<li class="courses {!! $exchangeState or '' !!}"><a href="{!! url('/study') !!}"><span class="glyphicon glyphicon-th-large" aria-hidden="true"></span> <span class="hidden-sm hidden-xs">Exchange</span></a>
						</li>
