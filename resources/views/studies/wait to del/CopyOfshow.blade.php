...
<body class="admin-bar">
	...
	<script type="text/javascript">
		//include('bible.partials.chapter-js')
		//include('partials.jquery-selectable-test')
	</script>
	
	
	<script type="text/javascript" src="/assets/react-with-addons.min.js"></script>	
	<script type="text/javascript" src="/assets/JSXTransformer.js"></script>
	<script type="text/jsx" src="/assets/study-space.js"></script>
